...
void Stage2RotatingArrow::Initialize(Model* model)
{
	assert(model);
	model_ = model;
	...
	worldTransform_.translation_ = {0.0f,0.0f,-1.8f };
...
void Stage2RotatingArrow::Update()
{
...
void Stage2RotatingArrow::OnCollision(Player* player)
{
	//速度調整
